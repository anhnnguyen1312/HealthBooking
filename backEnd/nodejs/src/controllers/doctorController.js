import {
  handlerGetAllDoctor,
  handlerGetTopDoctor,
  handlerSaveDetailDoctor,
  handlerGetDetailDoctorById,
  handlebulkCreateSchedule,
  handlegetScheduleDoctorByDateService,
...
//   await doctorService.postCreateSchedule(
//     req.user,
//     req.body.schedule_arr,
//     MAX_BOOKING
//   );
...
//   try {
//     let object = await doctorService.getScheduleDoctorByDate(
//       req.body.doctorId,
//       req.body.date
//     );
...
//     }
//     try {
//       let patient = await doctorService.sendFormsForPatient(
//         req.body.patientId,
//         req.files
//       );
//       return res.status(200).json({
...
let deleteHandbookById = async (req, res) => {
  try {
    let data = await handleDeleteHandbookById(req.body.id);
    return res.status(200).json({
      errCode: 0,
      errMessage: "ok",
      data: data,
...
let postHandBook = async (req, res) => {
  try {
    let data = await handlePostHandBook(req.body);
    return res.status(200).json({
      errCode: 0,
      errMessage: "ok",
      data: data,
...
let getHandbookById = async (req, res) => {
  try {
    ...
    let data = await handleGetHandbookById(req.query.id);
    return res.status(200).json({
      errCode: 0,
      errMessage: "ok",
      data: data,
...
let getAllHandbook = async (req, res) => {
  try {
    let data = await handleGetAllHandbook();
    return res.status(200).json({
      errCode: 0,
      errMessage: "ok",
      data: data,
...
let getAllDoctor = async (req, res) => {
  try {
    let data = await handlerGetAllDoctor();
    return res.status(200).json({
      errCode: 0,
      errMessage: "ok",
      data: data,
...
let getTopDoctor = async (req, res) => {
  try {
    let limitInput = Number(req.query.limit);
    let data = await handlerGetTopDoctor(limitInput);
    return res.status(200).json({
      errCode: 0,
      errMessage: "ok",
      data: data,
...
let saveDetailDoctor = async (req, res) => {
  try {
    const data = req.body;
    let response = await handlerSaveDetailDoctor(data);
    return res.status(200).json({
...
let getDetailDoctorById = async (req, res) => {
  try {
    ...
    let response = await handlerGetDetailDoctorById(data);
...
let bulkCreateSchedule = async (req, res) => {
  try {
    let response = await handlebulkCreateSchedule(req.body);
...
let getScheduleDoctorByDateService = async (req, res) => {
  try {
    let response = await handlegetScheduleDoctorByDateService(req.query);
