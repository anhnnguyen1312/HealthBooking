...
class BookingModal extends Component {
  ...
  buildNameAndProvinceByLanguage = (dataCurrentDoctor, languageRedux) => {
    ...
    if (
      dataCurrentDoctor &&
      dataCurrentDoctor.Doctor_Infor &&
      dataCurrentDoctor.Doctor_Infor.provinceData
    ) {
      provinceDoctor =
        languageRedux === LANGUAGES.VI
            ...
            <div className="form-user-container">
                ...
                <div className="form-row ">
                  <div className="form-group col-6">
                    <input
                      ...
                      onChange={(e) =>
                        this.handleChangeInput(e, "nameScheduler")
                      }
                  ...
                  <div className="form-group col-6">
                    <input
                      ...
                      onChange={(e) =>
                        this.handleChangeInput(e, "phoneNumberScheduler")
                      }
              ...
              {/* <div className="form-group">
                <input
                  type="text"
                  className="form-control"
                  placeholder="Mật khẩu để tạo tài khoản"
                  onChange={(e) => this.handleChangeInput(e, "namePatient")}
                  value={this.state.namePatient}
                />
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          value={item.keyMap}
                          onChange={(e) =>
                            this.handleChangeInput(e, "genderPatient")
                          }
                        />
              ...
              <div className="form-row ">
                <div className="form-group col-6">
                  <input
                    ...
                    onChange={(e) =>
                      this.handleChangeInput(e, "phoneNumberPatient")
                    }
              ...
              <div className="form-group ">
                <div className="">
                  <input
                    ...
                    placeholder="Địa chỉ"
                    onChange={(e) =>
                      this.handleChangeInput(e, "addressPatient")
                    }
