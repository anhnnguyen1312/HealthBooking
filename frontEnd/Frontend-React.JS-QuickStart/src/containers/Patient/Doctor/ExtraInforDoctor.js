...
class ExtraInforDoctor extends Component {
  ...
  async componentDidMount() {
    ...
    console.log(dataCurrentDoctor, "dataCurrentDoctor");
    this.setState({
      price: doctorInfor.priceTypeData,
      addressClinic: doctorInfor.addressClinic,
      typePayment: doctorInfor.paymentTypeData,
      province: doctorInfor.provinceTypeData,
  ...
  render() {
    ...
    let { price, addressClinic, typePayment, province, nameClinic } =
      this.state;
          ...
          {isShowPrice && (
            <table className="table-price">
              ...
              <tfoot className="row-price row2">
                <tr>
                  <td>
                    <FormattedMessage id="patient.schedule.typePaymentText" />{" "}
                    {typePayment}
                  </td>
                </tr>
              </tfoot>
