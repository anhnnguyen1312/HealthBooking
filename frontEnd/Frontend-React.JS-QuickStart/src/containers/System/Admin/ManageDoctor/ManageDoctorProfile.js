...
class ManageDoctorProfile extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  async componentDidMount() {
    await this.props.fetchRelateToDoctorInforRedux();
    console.log("userInfo", this.props.userInfo);
    if (this.props.DoctorRelatedInforRedux) {
    ...
    if (detailDoctorRedux.Markdown && detailDoctorRedux.Doctor_infor) {
      ...
      console.log("doctor_infor", doctor_infor);
