...
class ManageAppointment extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps.listAppointmentRedux !== listAppointmentRedux) {
      console.log("listAppointmentRedux", listAppointmentRedux);
      this.setState({
                        ...
                        <td>
                          {statusIdRedux === "S2" && (
                            <span>
                              <button
                                ...
                                onClick={() =>
                                  this.handleClickConfirm(item, false)
                                }
                              >
                                <FormattedMessage id="appointment.confirm" />
                              </button>
                          ...
                          {statusIdRedux === "S3" && (
                            <button
                              ...
                              onClick={() =>
                                this.handleClickConfirm(item, true)
                              }
                            >
                              <FormattedMessage id="appointment.remind" />
                            </button>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    changeStatusIdRedux: (statusId) =>
      dispatch(actions.changeStatusId(statusId)),
