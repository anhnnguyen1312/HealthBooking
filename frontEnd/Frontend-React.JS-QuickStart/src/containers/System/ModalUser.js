  ...
  handleClickSubmit = async () => {
    ...
    try {
      if (file.name) {
        ...
        const response = await uploadFileToFirebase(data);
        this.handleSaveUser(response.data?.secure_url);
                  ...
                  <div className="form-row">
                    <div className="form-group col-md-6">
                      ...
                      <input
                        ...
                        disabled={
                          currentAction === CRUD_ACTIONS.EDIT ? true : false
                        }
                      />
                    </div>
                    <div className="form-group col-md-6">
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group col-md-3">
                      ...
                      <input
                        ...
                        value={phoneNumber}
                        onChange={(e) =>
                          this.props.handleOnchangeInput(e, "phoneNumber")
                        }
                      />
                    </div>
                  </div>
                  <div className="form-row">
                    <div className="form-group col-md-3">
                      ...
                      <select
                        ...
                        className="form-control"
                        onChange={(e) =>
                          this.props.handleOnchangeInput(e, "gender")
                        }
                        value={gender}
                      >
                        {genders &&
                    ...
                    <div className="form-group col-md-3">
                      ...
                      <select
                        ...
                        className="form-control"
                        onChange={(e) =>
                          this.props.handleOnchangeInput(e, "position")
                        }
                      >
                        {positions &&
                          positions.length > 0 &&
                    ...
                    <div className="form-group col-md-3">
                      ...
                      <select
                        ...
                        className="form-control"
                        onChange={(e) =>
                          this.props.handleOnchangeInput(e, "roleId")
                        }
                      >
                        {roles &&
                          roles.length > 0 &&
