...
import { deleteSpecialtyByIdServices } from "../../../services";
...
class Specialty extends Component {
  ...
  handleDestroy = async () => {
    ...
    let response = await deleteSpecialtyByIdServices({
      ...
      <div className="specialty-container position-loading">
        ...
        {isOpenModel && (
          <ModalSpecialty
            ...
            reloadData={this.props.getAllSpecialtyRedux}
          />
        )}
        {isShowModalConfirm ? (
          <ModalConfirm
            ...
            type="confirm"
            size="nm"
            currentUserId={this.state.currentSpecialtyId}
          />
        ) : (
          ""
        )}
